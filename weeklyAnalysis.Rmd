...
```
Are counts increasing for seasons year over year?
```{r}
...
Inspect summary status of Cnt, Casual and Registered and see if for a given weekday proportion of casula and registered varies.
```{r}
