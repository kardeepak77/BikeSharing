...
![](Thursday_files/figure-gfm/unnamed-chunk-9-1.png)<!-- --> With
...
![](Thursday_files/figure-gfm/unnamed-chunk-10-1.png)<!-- --> Are counts
...
```
    ...
    ##                    RMSE
    ## Random Forest  965.5854
    ## MLR 1          879.5746
    ## Boosted Tree  1104.1408
    ## MLR 2          860.6850
...
```
    ...
    ## [1] "Best performing model for Thursday is MLR 2"
