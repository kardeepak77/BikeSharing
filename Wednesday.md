...
![](Wednesday_files/figure-gfm/unnamed-chunk-9-1.png)<!-- --> With
...
![](Wednesday_files/figure-gfm/unnamed-chunk-10-1.png)<!-- --> Are
counts increasing for seasons year over year?
...
```
    ...
    ##                    RMSE
    ## Random Forest 1089.0226
    ## MLR 1          885.9728
    ## Boosted Tree  1281.7730
    ## MLR 2          807.6976
...
```
    ...
    ## [1] "Best performing model for Wednesday is MLR 2"
